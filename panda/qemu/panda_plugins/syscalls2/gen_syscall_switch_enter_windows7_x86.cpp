...
int AddArgument(CPUState *env, void *arg, uint32_t arg_no, uint32_t size){
    ...
    rp.SyscallArgs.args[arg_no].arg1 = NULL;
    rp.SyscallArgs.args[arg_no].size2 = 0;
    rp.SyscallArgs.args[arg_no].arg2 = NULL;
...
int32_t AddArgument_pointer(CPUState *env, uint32_t arg_no, uint32_t size){
   ...
   /* if ( !(buffer = malloc(size))  || !(pointer_content = (uint32_t *)malloc(4)) ){
        faros_syscall << "\nAddArgument_pointer: malloc failed! size: " << size;
        faros_syscall.flush();
	    return -1;
	}*/
    //*pointer_content = get_pointer_buffer_32(env, arg_no, buffer, size, &pointer_addr);
    uint32_t ret= get_pointer_buffer_32(env, arg_no, &buffer, size, &pointer_addr);
    
    if(ret == 0)
        return -1;
    pointer_content = (uint32_t *)malloc(4);

    if(pointer_content == NULL){
        syscall_log("freeing memory-line:177");
        free(buffer);
        buffer = NULL;
        free((void *)pointer_content);
        pointer_content = NULL;
        return -1;
    }
    *pointer_content = ret;
    if(!AddArgument2(env, (void *)pointer_content, 4/*pointer_size*/, (void *)buffer, size, arg_no )){
        syscall_log("freeing memory-line:184");
        free(buffer);
        buffer = NULL;
        free((void *)pointer_content);
        pointer_content = NULL;
...
int AddArgument_struct_unicode_str(CPUState *env, uint32_t arg_no){
    ...
    if(!obj_name){
        //syscall_log("freeing memory-line:267");
        //free(struct_content);
        return 0;     
    }    
  
  	if(!AddArgument2(env, struct_content, struct_size, (void *)obj_name, ustr_size, arg_no )){
  	    syscall_log("freeing memory-line:273");
  	  	free(obj_name);
  	  	obj_name = NULL;
  	  	//free(struct_content);
        return 0;
...
int AddArgument_pwstr(CPUState *env, uint32_t arg_no, uint32_t ustr_size){
    ...
    if(!ustr){
        syscall_log("freeing memory-line:307");
        free((void *)pointer_value);
        pointer_value = NULL;
        return 0;
    }
  	if(!AddArgument2(env, (void *)pointer_value, pointer_size, (void *)ustr, ustr_size, arg_no )){
  	    syscall_log("freeing memory-line:312");
  	    free(ustr);
  	    ustr = NULL;
  	    free((void *)pointer_value);
  	    pointer_value = NULL;
...
int AddArgument_struct_afd_info(CPUState *env, uint32_t arg_no, uint32_t struct_size, uint32_t io_control_code){
   ...
   //     return 0;
    if(struct_size == 0)
        return -1;
    /*struct_content = (void *)malloc(struct_size);
    if (!struct_content){
	    faros_syscall << "\nAddArgument_struct_afd_info: malloc failed! size: " << struct_size;
        faros_syscall.flush();
	    return -1;
	}*/
...
if(AddArgument_pointer(env, 4, SECURITY_DESCRIPTOR_SIZE) == -1)
    AddArgument(env, (void *)&arg4, 4, sizeof(uint32_t));
if(AddArgument_pointer(env, 5, POINTER_SIZE))
    AddArgument(env, (void *)&arg5, 5, sizeof(uint32_t));
AddArgument(env, (void *)&arg6, 6, sizeof(uint32_t));
AddArgument(env, (void *)&arg7, 7, sizeof(uint32_t));
AddArgument(env, (void *)&arg8, 8, sizeof(uint32_t));
...
// 79 NTSTATUS NtCreateProcess ['_Out_ PHANDLE ProcessHandle', '_In_ ACCESS_MASK DesiredAccess', '_In_ POBJECT_ATTRIBUTES ObjectAttributes', '_In_ HANDLE ParentProcess', '_In_ BOOLEAN InheritObjectTable', '_In_ HANDLE SectionHandle', '_In_ HANDLE DebugPort', '_In_ HANDLE ExceptionPort']
case 79: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 213 NTSTATUS NtPropagationComplete ['_In_ HANDLE ResourceManagerHandle', ' _In_ ULONG RequestCookie', ' _In_ ULONG BufferLength', ' _In_ PVOID Buffer']
case 213: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 214 NTSTATUS NtPropagationFailed ['_In_ HANDLE ResourceManagerHandle', '_In_ ULONG RequestCookie', '_In_ NTSTATUS PropStatus']
case 214: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 219 NTSTATUS NtQueryBootOptions ['_In_ PBOOT_OPTIONS BootOptions', '_In_ PULONG BootOptionsLength']
case 219: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
...
// 220 NTSTATUS NtQueryDebugFilterState ['_In_ ULONG ComponentId', ' _In_ ULONG Level']
case 220: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
...
// 221 NTSTATUS NtQueryDefaultLocale ['_In_ BOOLEAN UserProfile', '_Out_ PLCID DefaultLocaleId']
case 221: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
...
// 223 NTSTATUS NtQueryDirectoryFile ['_In_ HANDLE FileHandle', '_In_opt_ HANDLE Event', '_In_opt_ PIO_APC_ROUTINE ApcRoutine', '_In_opt_ PVOID ApcContext', '_Out_ PIO_STATUS_BLOCK IoStatusBlock', ' _Out_ PVOID FileInformation', ' _In_ ULONG Length', '_In_ FILE_INFORMATION_CLASS FileInformationClass', '_In_ BOOLEAN ReturnSingleEntry', '_In_opt_ PUNICODE_STRING FileName', '_In_ BOOLEAN RestartScan']
case 223: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 224 NTSTATUS NtQueryDirectoryObject ['_In_ HANDLE DirectoryHandle', ' _Out_opt_ PVOID Buffer', '_In_ ULONG BufferLength', '_In_ BOOLEAN ReturnSingleEntry', '_In_ BOOLEAN RestartScan', '_Inout_ PULONG Context', '_Out_opt_ PULONG ReturnLength']
case 224: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 225 NTSTATUS NtQueryDriverEntryOrder ['_In_ PULONG Ids', ' _In_ PULONG Count']
case 225: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
if(AddArgument_pointer(env, 0, ULONG_SIZE) == -1)
...
// 227 NTSTATUS NtQueryEvent ['_In_ HANDLE EventHandle', '_In_ EVENT_INFORMATION_CLASS EventInformationClass', ' _Out_ PVOID EventInformation', '_In_  ULONG EventInformationLength', ' _Out_ PULONG ReturnLength']
case 227: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 229 NTSTATUS NtQueryInformationAtom ['_In_ RTL_ATOM Atom', '_Out_  ATOM_INFORMATION_CLASS AtomInformationClass', '_Out_ PVOID AtomInformation', '_In_  ULONG AtomInformationLength', '_In_ PULONG ReturnLength']
case 229: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 230 NTSTATUS NtQueryInformationEnlistment ['_In_ HANDLE EnlistmentHandle', '_In_ ENLISTMENT_INFORMATION_CLASS EnlistmentInformationClass', '_Out_ PVOID EnlistmentInformation', '_In_ ULONG EnlistmentInformationLength', ' _Out_opt_ PULONG ReturnLength']
case 230: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 231 NTSTATUS NtQueryInformationFile ['_In_ HANDLE FileHandle', '_Out_ PIO_STATUS_BLOCK IoStatusBlock', '_Out_ PVOID FileInformation', '_In_ ULONG Length', '_In_ FILE_INFORMATION_CLASS FileInformationClass']
case 231: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 234 NTSTATUS NtQueryInformationProcess ['_In_ HANDLE ProcessHandle', ' _In_ PROCESSINFOCLASS ProcessInformationClass', ' _Out_ PVOID ProcessInformation', ' _In_ ULONG ProcessInformationLength', ' _Out_opt_ PULONG ReturnLength']
case 234: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 235 NTSTATUS NtQueryInformationResourceManager ['_In_ HANDLE ResourceManagerHandle', '_In_ RESOURCEMANAGER_INFORMATION_CLASS ResourceManagerInformationClass', '_Out_ PVOID ResourceManagerInformation', '_In_ ULONG ResourceManagerInformationLength', ' _Out_opt_ PULONG ReturnLength']
case 235: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 236 NTSTATUS NtQueryInformationThread ['_In_ HANDLE ThreadHandle', ' _In_ THREADINFOCLASS ThreadInformationClass', '_Inout_ PVOID ThreadInformation', '_In_ ULONG ThreadInformationLength', ' _Out_opt_ PULONG ReturnLength']
case 236: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 237 NTSTATUS NtQueryInformationToken ['_In_ HANDLE TokenHandle', '_In_ TOKEN_INFORMATION_CLASS TokenInformationClass', '_Out_ PVOID TokenInformation', '_In_ ULONG TokenInformationLength', '_Out_ PULONG ReturnLength']
case 237: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 238 NTSTATUS NtQueryInformationTransaction ['_In_ HANDLE TransactionHandle', ' _In_ TRANSACTION_INFORMATION_CLASS TransactionInformationClass', ' _Out_ PVOID TransactionInformation', ' _In_ ULONG TransactionInformationLength', '  _Out_opt_ PULONG ReturnLength']
case 238: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 239 NTSTATUS NtQueryInformationTransactionManager [_In_ HANDLE TransactionManagerHandle, _In_ TRANSACTIONMANAGER_INFORMATION_CLASS, TransactionManagerInformationClass, _Out_  PVOID  TransactionManagerInformation, _In_ ULONG TransactionManagerInformationLength, _Out_opt_ PULONG ReturnLength]
case 239: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 241 NTSTATUS NtQueryInstallUILanguage ['_Out_ PLANGID LanguageId']
case 241: {
uint32_t arg0 = get_32(env, 0);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
PPP_RUN_CB(on_NtQueryInstallUILanguage_enter, env,pc,arg0) ; 
}; break;
// 242 NTSTATUS NtQueryIntervalProfile [' _In_ KPROFILE_SOURCE ProfileSource', '_Out_ PULONG Interval']
case 242: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
...
// 243 NTSTATUS NtQueryIoCompletion ['_In_ HANDLE IoCompletionHandle', ' _In_ IO_COMPLETION_INFORMATION_CLASS IoCompletionInformationClass', '_Out_ PVOID IoCompletionInformation', ' _In_ ULONG IoCompletionInformationLength', ' _Out_ PULONG ResultLength']
case 243: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 244 NTSTATUS NtQueryKey ['_In_ HANDLE KeyHandle', '_In_ KEY_INFORMATION_CLASS KeyInformationClass', '_Out_opt_ PVOID KeyInformation', '_In_ ULONG Length', '_Out_ PULONG ResultLength']
case 244: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 246 NTSTATUS NtQueryMultipleValueKey ['_In_ HANDLE KeyHandle', '_Inout_ PKEY_VALUE_ENTRY ValueList', '_In_ ULONG NumberOfValues', '_In_ PVOID Buffer', '_Inout_ PULONG Length', '_Out_opt_ PULONG ReturnLength']
case 246: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 248 NTSTATUS NtQueryObject ['_In_opt_ HANDLE ObjectHandle', '_In_ OBJECT_INFORMATION_CLASS ObjectInformationClass', '_In_opt_ PVOID ObjectInformation', '_In_ ULONG Length', '_In_opt_ PULONG ResultLength']
case 248: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 251 NTSTATUS NtQueryPerformanceCounter ['_Out_ PLARGE_INTEGER Counter', '_Out_opt_ PLARGE_INTEGER Frequency']
case 251: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
if(AddArgument_pointer(env, 0, LARGE_INTEGER_SIZE) == -1)
...
// 253 NTSTATUS NtQueryQuotaInformationFile ['_In_ HANDLE FileHandle', ' _Out_ PIO_STATUS_BLOCK IoStatusBlock', '_Out_ PVOID Buffer', '_In_ ULONG Length', '_In_ BOOLEAN ReturnSingleEntry', '_In_opt_ PVOID SidList', '_In_ ULONG SidListLength', '_In_opt_ PSID StartSid', '_In_ BOOLEAN RestartScan']
case 253: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 255 NTSTATUS NtQuerySecurityAttributesToken [_In_ HANDLE TokenHandle, _In_reads_opt_(NumberOfAttributes) PUNICODE_STRING Attributes, _In_ ULONG NumberOfAttributes, _Out_writes_bytes_(Length) PVOID Buffer, _In_ ULONG Length, _Out_ PULONG ReturnLength]
case 255: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 256 NTSTATUS NtQuerySecurityObject ['_In_ HANDLE Handle', '_In_ SECURITY_INFORMATION SecurityInformation', '_Out_ PSECURITY_DESCRIPTOR SecurityDescriptor', '_In_ ULONG Length', '_Out_ PULONG ResultLength']
case 256: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 258 NTSTATUS NtQuerySymbolicLinkObject ['_In_ HANDLE SymLinkObjHandle', '_Inout_ PUNICODE_STRING LinkTarget', '_Out_opt_ PULONG DataWritten']
case 258: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 261 NTSTATUS NtQuerySystemInformation ['_In_  SYSTEM_INFORMATION_CLASS SystemInformationClass', '_Inout_  PVOID SystemInformation', '_In_  SIZE_T Length', '_Out_opt_ PSIZE_T ResultLength']
case 261: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 263 NTSTATUS NtQuerySystemTime ['_Out_ PLARGE_INTEGER CurrentTime']
case 263: {
uint32_t arg0 = get_32(env, 0);
if(AddArgument_pointer(env, 0, LARGE_INTEGER_SIZE) == -1)
    AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
...
// 266 NTSTATUS NtQueryValueKey ['_In_ HANDLE KeyHandle', '_In_ PUNICODE_STRING ValueName', '_In_ KEY_VALUE_INFORMATION_CLASS KeyValueInformationClass', '_Out_opt_ PVOID KeyValueInformation', '_In_ ULONG Length', '_Out_ PULONG ResultLength']
case 266: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 267 NTSTATUS NtQueryVirtualMemory ['_In_ HANDLE ProcessHandle', '_In_opt_ PVOID Address', '_In_ MEMORY_INFORMATION_CLASS VirtualMemoryInformationClass', '_Out_ PVOID VirtualMemoryInformation', '_In_ SIZE_T Length', '_Out_opt_ PSIZE_T ResultLength']
case 267: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 268 NTSTATUS NtQueryVolumeInformationFile ['_In_ HANDLE FileHandle', '_Out_ PIO_STATUS_BLOCK IoStatusBlock', '_Out_ PVOID FsInformation', '_In_ ULONG Length', '_In_ FS_INFORMATION_CLASS FsInformationClass']
case 268: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 273 NTSTATUS NtReadFile [ _In_ HANDLE FileHandle, _In_opt_ HANDLE Event, _In_opt_ PIO_APC_ROUTINE  ApcRoutine,_In_opt_ PVOID ApcContext, _Out_ PIO_STATUS_BLOCK IoStatusBlock, _Out_    PVOID Buffer,  _In_ ULONG Length,  _In_opt_ PLARGE_INTEGER ByteOffset, _In_opt_ PULONG Key]
case 273: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 275 NTSTATUS NtReadOnlyEnlistment ['_In_ HANDLE EnlistmentHandle', '_In_opt_ PLARGE_INTEGER TmVirtualClock']
case 275: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
...
// 277 NTSTATUS NtReadVirtualMemory ['_In_ HANDLE ProcessHandle', ' _In_ PVOID BaseAddress', ' _Out_ PVOID Buffer', '_In_ SIZE_T NumberOfBytesToRead', '_Out_ PSIZE_T NumberOfBytesRead']
case 277: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 278 NTSTATUS NtRecoverEnlistment ['_In_ HANDLE EnlistmentHandle', '_In_opt_ PVOID EnlistmentKey']
case 278: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
...
// 279 NTSTATUS NtRecoverResourceManager ['_In_ HANDLE ResourceManagerHandle']
case 279: {
uint32_t arg0 = get_32(env, 0);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
//PPP_RUN_CB(on_NtRecoverResourceManager_enter, env,pc,arg0) ; 
}; break;
// 280 NTSTATUS NtRecoverTransactionManager ['_In_ HANDLE TransactionManagerHandle']
case 280: {
uint32_t arg0 = get_32(env, 0);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
...
// 282 NTSTATUS NtRegisterThreadTerminatePort ['_In_ HANDLE TerminationPort']
case 282: {
uint32_t arg0 = get_32(env, 0);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
...
// 290 NTSTATUS NtRenameKey ['_In_ HANDLE KeyHandle', '_In_ PUNICODE_STRING ReplacementName']
case 290: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
...
// 291 NTSTATUS NtRenameTransactionManager ['_In_ PUNICODE_STRING LogFileName', '_In_ LPGUID ExistingTransactionManagerGuid']
case 291: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
if(!AddArgument_struct_unicode_str(env, 0))
...
// 297 NTSTATUS NtReplyWaitReplyPort ['_In_ HANDLE PortHandle', '_Inout_ PPORT_MESSAGE ReplyMessage']
case 297: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
...
// 300 NTSTATUS NtResetEvent ['_In_ HANDLE EventHandle', '_Out_ PLONG NumberOfWaitingThreads']
case 300: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
...
// 302 NTSTATUS NtRestoreKey ['_In_ HANDLE KeyHandle', '_In_ HANDLE FileHandle', '_In_ ULONG RestoreFlags']
case 302: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 305 NTSTATUS NtRollbackComplete ['_In_ HANDLE EnlistmentHandle', '_In_opt_ PLARGE_INTEGER TmVirtualClock']
case 305: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
...
// 306 NTSTATUS NtRollbackEnlistment ['_In_ HANDLE EnlistmentHandle', '_In_opt_ PLARGE_INTEGER TmVirtualClock']
case 306: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
...
// 307 NTSTATUS NtRollbackTransaction ['_In_ HANDLE TransactionHandle', '_In_ BOOLEAN Wait']
case 307: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
...
// 308 NTSTATUS NtRollforwardTransactionManager ['_In_ HANDLE TransactionManagerHandle', '_In_opt_ PLARGE_INTEGER TmVirtualClock']
case 308: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
...
// 314 NTSTATUS NtSetBootEntryOrder ['_In_ PULONG Ids', '_In_ ULONG Count']
case 314: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
if(AddArgument_pointer(env, 0, ULONG_SIZE) == -1)
...
// 318 NTSTATUS NtSetDefaultHardErrorPort ['_In_ HANDLE PortHandle']
case 318: {
uint32_t arg0 = get_32(env, 0);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
...
// 320 NTSTATUS NtSetDefaultUILanguage ['_In_ LANGID LanguageId']
case 320: {
uint32_t arg0 = get_32(env, 0);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
...
// 322 NTSTATUS NtSetEaFile ['_In_ HANDLE FileHandle', '_Out_ PIO_STATUS_BLOCK IoStatusBlock', '_In_ PVOID EaBuffer', '_In_ ULONG EaBufferSize']
case 322: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 323 NTSTATUS NtSetEvent ['_In_ HANDLE EventHandle', '_Out_opt_ PLONG PreviousState ']
case 323: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
...
// 325 NTSTATUS NtSetHighEventPair ['_In_ HANDLE EventPairHandle']
case 325: {
uint32_t arg0 = get_32(env, 0);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
PPP_RUN_CB(on_NtSetHighEventPair_enter, env,pc,arg0) ; 
}; break;
// 326 NTSTATUS NtSetHighWaitLowEventPair ['_In_ HANDLE EventPairHandle']
case 326: {
uint32_t arg0 = get_32(env, 0);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
...
// 329 NTSTATUS NtSetInformationFile ['_In_ HANDLE FileHandle', '_Out_ PIO_STATUS_BLOCK IoStatusBlock', '_In_ PVOID FileInformation', '_In_ ULONG Length', '_In_ FILE_INFORMATION_CLASS FileInformationClass']
case 329: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 331 NTSTATUS NtSetInformationKey ['_In_ HANDLE KeyHandle', '_In_ KEY_SET_INFORMATION_CLASS KeyInformationClass', '_In_ PVOID KeyInformation', '_In_ ULONG KeyInformationLength']
case 331: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 335 NTSTATUS NtSetInformationThread ['_In_ HANDLE ThreadHandle', '_In_ THREADINFOCLASS ThreadInformationClass', '_In_ PVOID ThreadInformation', '_In_ ULONG ThreadInformationLength']
case 335: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 336 NTSTATUS NtSetInformationToken [' _In_ HANDLE TokenHandle', '  _In_ TOKEN_INFORMATION_CLASS TokenInformationClass', ' _In_ PVOID TokenInformation', ' _In_ ULONG TokenInformationLength']
case 336: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 337 NTSTATUS NtSetInformationTransaction ['_In_ HANDLE TransactionHandle', '_In_ TRANSACTION_INFORMATION_CLASS TransactionInformationClass', '_In_ PVOID TransactionInformation', '_In_ ULONG TransactionInformationLength']
case 337: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 345 NTSTATUS NtSetLowWaitHighEventPair ['_In_ HANDLE EventPair']
case 345: {
uint32_t arg0 = get_32(env, 0);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
PPP_RUN_CB(on_NtSetLowWaitHighEventPair_enter, env,pc,arg0) ; 
}; break;
// 346 NTSTATUS NtSetQuotaInformationFile ['_In_ HANDLE FileHandle', '_Out_ PIO_STATUS_BLOCK IoStatusBlock', '_In_ PVOID Buffer', '_In_ ULONG BufferLength']
case 346: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 347 NTSTATUS NtSetSecurityObject ['_In_ HANDLE Handle', '_In_ SECURITY_INFORMATION SecurityInformation', '_In_ PSECURITY_DESCRIPTOR SecurityDescriptor']
case 347: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 352 NTSTATUS NtSetSystemTime ['_In_ PLARGE_INTEGER SystemTime', '_Out_ PLARGE_INTEGER NewSystemTime']
case 352: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
if(AddArgument_pointer(env, 0, LARGE_INTEGER_SIZE) == -1)
...
// 356 NTSTATUS NtSetTimerResolution ['_In_ ULONG RequestedResolution', '_In_ BOOLEAN SetOrUnset', '_Out_ PULONG ActualResolution']
case 356: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 357 NTSTATUS NtSetUuidSeed ['_In_ PUCHAR UuidSeed']
case 357: {
uint32_t arg0 = get_32(env, 0);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
PPP_RUN_CB(on_NtSetUuidSeed_enter, env,pc,arg0) ; 
}; break;
// 358 NTSTATUS NtSetValueKey ['_In_ HANDLE KeyHandle', '_In_ PUNICODE_STRING ValueName', '_In_opt_ ULONG TitleIndex', '_In_ ULONG Type', '_In_opt_ PVOID Data', '_In_ ULONG DataSize']
case 358: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 359 NTSTATUS NtSetVolumeInformationFile ['_In_ HANDLE FileHandle', '_Out_ PIO_STATUS_BLOCK IoStatusBlock', '_In_ PVOID FsInformation', '_In_ ULONG Length', '_In_ FS_INFORMATION_CLASS FsInformationClass']
case 359: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 363 NTSTATUS NtSinglePhaseReject ['_In_ HANDLE EnlistmentHandle', '_In_opt_ PLARGE_INTEGER TmVirtualClock']
case 363: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
...
// 365 NTSTATUS NtStopProfile ['_In_ HANDLE ProfileHandle']
case 365: {
uint32_t arg0 = get_32(env, 0);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
PPP_RUN_CB(on_NtStopProfile_enter, env,pc,arg0) ; 
}; break;
// 366 NTSTATUS NtSuspendProcess ['_In_ HANDLE ProcessHandle']
case 366: {
uint32_t arg0 = get_32(env, 0);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
PPP_RUN_CB(on_NtSuspendProcess_enter, env,pc,arg0) ; 
}; break;
// 367 NTSTATUS NtSuspendThread ['_In_ HANDLE ThreadHandle', '_Out_ PULONG PreviousSuspendCount']
case 367: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
...
// 370 NTSTATUS NtTerminateProcess ['_In_opt_ HANDLE ProcessHandle', '_In_ NTSTATUS ExitStatus']
case 370: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
...
// 375 NTSTATUS NtTraceControl [_In_ ULONG FunctionCode, _In_reads_bytes_opt_(InBufferLen) PVOID InBuffer, _In_ ULONG InBufferLen, _Out_writes_bytes_opt_(OutBufferLen) PVOID OutBuffer, _In_ ULONG OutBufferLen, _Out_ PULONG ReturnLength]
case 375: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 378 NTSTATUS NtUmsThreadYield ['_In_ PVOID SchedulerParam']
case 378: {
uint32_t arg0 = get_32(env, 0);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
//PPP_RUN_CB(on_NtUmsThreadYield_enter, env,pc,arg0) ; 
}; break;
// 379 NTSTATUS NtUnloadDriver ['_In_ PUNICODE_STRING DriverServiceName']
case 379: {
uint32_t arg0 = get_32(env, 0);
if(!AddArgument_struct_unicode_str(env, 0))
    AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
...
// 380 NTSTATUS NtUnloadKey ['_In_ POBJECT_ATTRIBUTES KeyObjectAttributes']
case 380: {
uint32_t arg0 = get_32(env, 0);
if(!AddArgument_struct_obj_attr(env, 0))
    AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
...
// 383 NTSTATUS NtUnlockFile ['_In_ HANDLE FileHandle', '_Out_ PIO_STATUS_BLOCK IoStatusBlock', '_In_ PLARGE_INTEGER ByteOffset', '_In_ PLARGE_INTEGER Lenght', '_In_ ULONG Key']
case 383: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 385 NTSTATUS NtUnmapViewOfSection ['_In_ HANDLE ProcessHandle', '_In_opt_ PVOID BaseAddress']
case 385: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
...
// 389 NTSTATUS NtWaitForMultipleObjects ['_In_ ULONG Count', ' _In_ HANDLE Object[]', ' _In_ WAIT_TYPE WaitType', ' _In_ BOOLEAN Alertable', ' _In_ PLARGE_INTEGER Time']
case 389: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 391 NTSTATUS NtWaitForSingleObject ['_In_ HANDLE Object', ' _In_ BOOLEAN Alertable', ' _In_ PLARGE_INTEGER Time']
case 391: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 393 NTSTATUS NtWaitHighEventPair ['_In_ HANDLE EventPairHandle']
case 393: {
uint32_t arg0 = get_32(env, 0);
AddArgument(env, (void *)&arg0, 0, sizeof(uint32_t));
...
// 397 NTSTATUS NtWriteFile [ _In_ HANDLE FileHandle, _In_opt_ HANDLE Event, _In_opt_ PIO_APC_ROUTINE ApcRoutine, _In_opt_ PVOID ApcContext,_Out_ PIO_STATUS_BLOCK IoStatusBlock,_In_     PVOID Buffer, _In_ ULONG Length, _In_opt_ PLARGE_INTEGER ByteOffset, _In_opt_ PULONG Key]
case 397: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
...
// 398 NTSTATUS NtWriteRequestData ['_In_ HANDLE PortHandle', '_In_ PPORT_MESSAGE Message', '_In_ ULONG Index', '_In_ PVOID Buffer', '_In_ ULONG BufferLength', '_Out_ PULONG ReturnLength']
case 398: {
uint32_t arg0 = get_32(env, 0);
uint32_t arg1 = get_32(env, 1);
uint32_t arg2 = get_32(env, 2);
